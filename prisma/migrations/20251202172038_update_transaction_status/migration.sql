/*
  ...
  - The values [Failed,Refunded] on the enum `TransactionStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "TransactionStatus_new" AS ENUM ('Pending', 'Success', 'Cancel');
